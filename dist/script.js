...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init();
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_3__["default"]('.showup .play', '.overlay');
  player.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_4__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_5__["default"]('.form').init();
});
    ...
    value: function bindTriggers(container, items, counter) {
      container.querySelector('.plus').addEventListener('click', function () {
        ...
        if (counter !== items.length - 2) {
          ...
          items[counter].style.display = 'flex';
          items[counter].classList.remove('slideInDown');
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          e.preventDefault(); //div unde va fi inscrisa rezultatr=eul trasnmiterii formei
...
var Slider = //container-blocul de baza unde is slideurile
